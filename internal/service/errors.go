...
func (e *errorHandler) createErrorResponseWithSpan(span opentracing.Span, err error, developerMessage string) error {
	if err == nil {
		return nil
	}
	...
	return e.createErrorResponse(err, developerMessage)
}

func (e *errorHandler) createErrorResponse(err error, developerMessage string) error {
